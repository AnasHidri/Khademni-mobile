 ...
 * @author user
 */
public class ListeEvenementEmp extends Form{
     Form current;
    public ListeEvenementEmp(Resources res ) {
...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
       ...
       // rbs[0].setSelected(true);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          ListeEvenementEmp a = new ListeEvenementEmp(res);
            a.show();
            refreshTheme();
        });
...
statLike.showTopEventsByLikes(myLabel);
    ...
    ipDlg.dispose();
        ...
        ArrayList<Evenement>list = EvenementService.getInstance().affichageEvenementEmp();
